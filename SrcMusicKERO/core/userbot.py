...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER("مـيـوزك زد إي").info(f"جـار تـشـغـيـل الـحـسـاب الـمـسـاعـد")
        if config.STRING1:
            ...
            LOGGER("مـيـوزك زد إي").info(f"تم بدء تشغيل الحساب المساعد {self.one.name} ...✓")
