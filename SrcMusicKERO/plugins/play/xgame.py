...
GAME_MESSAGE = "HEY In Music Game 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱"
GAME_BUTTONS = [
    [ 
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "Hey My Dear In game for 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "Hey My Dear For game in source music Ze"
               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('games⅒', callback_data= 'GAME1'),
                      InlineKeyboardButton ('games⅕', callback_data= 'GAME2')
               ...
               SOURCE_GAME = "Hey in 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 This is main game in source" 
